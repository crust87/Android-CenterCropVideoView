...
package com.crust87.centercropvideoview.widget;
...
public class CenterCropVideoView extends TextureView implements MediaPlayerControl {
    ...
    public CenterCropVideoView(final Context context) {
        super(context);
        isSound = true;
        isPlayable = false;
        mContext = context;
    ...
    public CenterCropVideoView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        isSound = true;
        isPlayable = false;
        mContext = context;
